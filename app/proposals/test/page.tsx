...
const PROPOSAL = {
  ...
  destinations: "Miami, FL & Austin, TX",
  groupSize: 80,
  message:
    "Hey Test Group, really excited to put this trip together for you. We have handled hundreds of trips like this and take a lot of pride in making sure everything goes perfectly. If you have any questions before signing, reach out directly.",
};
...
const HOTELS: Hotel[] = [
  {
    name: "The Miami Beach Hotel",
    destination: "Miami, FL",
    image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=800&auto=format&fit=crop",
    stars: 4,
    address: "123 Ocean Drive, Miami Beach, FL 33139",
    distance: "0.2 miles from the beach",
    busPerPerson: 75.00,
    dates: [
      { short: "Jan 10–12", range: "January 10 – 12, 2026", nights: 2, note: "Peak weekend",  pricePerPerson: 113.43, totalCost: 15074.40 },
      { short: "Jan 17–19", range: "January 17 – 19, 2026", nights: 2, note: "Great value",   pricePerPerson: 102.03, totalCost: 14162.40 },
      { short: "Jan 24–26", range: "January 24 – 26, 2026", nights: 2, note: "Best price",    pricePerPerson:  84.93, totalCost: 12794.40 },
    ],
  },
  {
    name: "Austin Downtown Marriott",
    destination: "Austin, TX",
    image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800&auto=format&fit=crop",
    stars: 4,
    address: "456 Congress Ave, Austin, TX 78701",
    distance: "0.3 miles from 6th Street",
    busPerPerson: 65.00,
    dates: [
      { short: "Jan 10–12", range: "January 10 – 12, 2026", nights: 2, note: "Popular weekend", pricePerPerson: 107.73, totalCost: 13818.40 },
      { short: "Jan 17–19", range: "January 17 – 19, 2026", nights: 2, note: "Good value",      pricePerPerson:  90.63, totalCost: 12450.40 },
      { short: "Jan 24–26", range: "January 24 – 26, 2026", nights: 2, note: "Best price",      pricePerPerson:  73.53, totalCost: 11082.40 },
    ],
  },
];
...
export default function TestProposalPage() {
  ...
  const busTotal = hotel && dateOpt ? Math.round(hotel.busPerPerson * groupSize * 100) / 100 : 0;
  const hotelSubtotal = dateOpt ? Math.round(dateOpt.pricePerPerson * groupSize * 100) / 100 : 0;
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col px-6 pb-6 pt-4">
                              ...
                              {h.dates.map((d, di) => {
                                ...
                                return (
                                  <motion.button
                                    key={d.short}
                                    whileTap={{ scale: 0.95 }}
                                    onClick={(e) => { e.stopPropagation(); selectDate(i, di); }}
                                  ...
                                  >
                                    <span>{d.short}</span>
                                    <span className={`ml-1.5 text-xs ${dateActive ? "text-white/70" : "text-ink/35 group-hover:text-brand/60"}`}>
                                      · {d.note}
                                    </span>
                                  </motion.button>
                                );
                          ...
                          <div className="mt-auto pt-4">
                            <motion.button
                              whileTap={{ scale: 0.97 }}
                              onClick={(e) => { e.stopPropagation(); selectHotel(i); }}
          ...
          <div className="mx-auto mt-14 max-w-2xl rounded-3xl bg-white p-8 shadow-sm shadow-ink/5 sm:p-10">
            ...
            <div className="py-5">
              ...
              <div className="flex items-center justify-between gap-3 border-t border-ink/10 py-3">
                ...
                <div className="flex shrink-0 gap-4">
                  <p className="w-[88px] text-right font-semibold text-ink">{hotel ? fmt(hotel.busPerPerson) : "—"}</p>
                  <p className="w-[100px] text-right font-semibold text-ink">
            ...
            <div className="rounded-xl border border-ink/10 p-5">
              <p className="text-xs font-semibold uppercase tracking-widest text-ink/40">Payment Schedule</p>
              <div className="mt-4 space-y-5">
                <div>
                  <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-ink/40">Due on Signing</p>
        ...
        <div className="mx-auto max-w-site">
          ...
          <div className="mx-auto mt-14 max-w-3xl">
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-widest text-ink/45">Full Name</label>
                <input
                  type="text"
                  value={fullName}
              ...
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-widest text-ink/45">Date</label>
                <input
                  type="text"
                  value={todayStr}
                  readOnly
                ...
                {signature && (
                  ...
                  >
                    <div className="mt-3 rounded-xl border border-brand/20 bg-brand/5 px-5 py-4">
                      ...
                      <p className="text-4xl text-ink/75" style={{ fontFamily: "var(--font-dancing)" }}>
                        {signature}
                      </p>
                    </div>
                  </motion.div>
