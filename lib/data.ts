...
export const ARTICLES = [
  {
    ...
    body: [
      ...
      "3–4 Months Out: Build the Weekend",
      "With the hotel secured, start filling in the rest of the itinerary.",
      "This is when you can focus on transportation, formal dinner, private venues, nightlife, excursions, and other group activities. For a large group, a restaurant or venue that works perfectly for 20 people may not work at all for 150.",
      "The goal isn't to schedule every minute of the weekend. It's to make sure the parts of the trip that require reservations or private space are handled before the best options disappear.",
