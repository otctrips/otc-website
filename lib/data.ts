...
export const GALLERY: GalleryItem[] = [
  { src: u("photo-1514924013411-cbf25faa35bb"), destination: "Nashville, TN", tripType: "Fraternity Formal", tags: ["Formals", "Domestic", "Vacation" ], description: "Broadway, rooftop bars, live music, and a hotel block right in the heart of downtown. Nashville is one of our most popular formal destinations for a reason.", avgPrice: "$100" },
  { src: u("photo-1511795409834-ef04bbd61622"), destination: "Charleston, SC", tripType: "Sorority Formal", tags: ["Formals", "Domestic", "Vacation"], description: "Historic streets, waterfront venues, and Southern charm. Charleston is the perfect backdrop for a formal your chapter will be talking about for years.", avgPrice: "$120" },
  { src: u("photo-1492684223066-81342ee5ff30"), destination: "New Orleans, LA", tripType: "Fraternity Formal", tags: ["Formals", "Domestic", "Vacation"], description: "Bourbon Street, private venues, and a city that was built for a good time. New Orleans delivers an experience no other formal destination can match.", avgPrice: "$100" },
  { src: u("photo-1510414842594-a61c69b5ae57"), destination: "Cancun, MX", tripType: "Spring Break", tags: ["Spring Break", "International", "Vacation", "Formals"], description: "All-inclusive resorts, white sand beaches, and the best hotel deals in the Caribbean. Cancun is spring break done right.", avgPrice: "$120" },
  { src: u("photo-1540541338287-41700207dee6"), destination: "Punta Cana, DR", tripType: "Spring Break", tags: ["Spring Break", "International", "Vacation", "Formals"], description: "Crystal clear water, luxury resorts, and group rates that actually make sense. Punta Cana is where your whole group can travel together without breaking the bank.", avgPrice: "$100" },
  { src: u("photo-1506966953602-c20cc11f75e3"), destination: "Miami, FL", tripType: "Spring Break", tags: ["Spring Break", "Domestic"], description: "South Beach, rooftop pools, and nightlife that goes all weekend. Miami is the domestic spring break that feels international.", avgPrice: "$100" },
  { src: u("photo-1476514525535-07fb3b4ae5f1"), destination: "Lake Tahoe, NV", tripType: "Chapter Retreat", tags: ["Retreats", "Domestic"], description: "Mountain views, lakeside lodges, and a setting that gets everyone off their phones. Tahoe is the retreat destination that actually feels like a retreat.", avgPrice: "$100" },
  { src: u("photo-1551524559-8af4e6624178"), destination: "Aspen, CO", tripType: "Ski Retreat", tags: ["Retreats", "Domestic"], description: "World-class skiing, mountain lodges, and a group trip that writes itself. Aspen is the winter retreat your chapter has been waiting for.", avgPrice: "$100" },
  { src: u("photo-1529156069898-49953e39b3ac"), destination: "Savannah, GA", tripType: "Sorority Retreat", tags: ["Retreats", "Formals", "Domestic"], description: "Spanish moss, historic squares, and a pace that lets your chapter actually connect. Savannah is the retreat destination that surprises everyone who goes.", avgPrice: "$100" },
  { src: u("photo-1473116763249-2faaef81ccda"), destination: "Ibiza, Spain", tripType: "Spring Break", tags: ["Spring Break", "International"], description: "The world's most famous party island, with group flights and hotel blocks that make the trip actually doable. Ibiza is the international spring break that lives up to the hype.", avgPrice: "$100" },
  { src: u("photo-1523906834658-6e24ef2386f9"), destination: "Florence, Italy", tripType: "Sorority Trip", tags: ["Retreats", "International"], description: "Renaissance art, incredible food, and cobblestone streets that make every photo look professional. Florence is the international trip your chapter will never forget.", avgPrice: "$100" },
  { src: u("photo-1506929562872-bb421503ef21"), destination: "Turks & Caicos", tripType: "Corporate Incentive", tags: ["Corporate", "International"], description: "Turquoise water, private beaches, and a luxury resort experience that rewards your top performers. Turks & Caicos is the incentive trip that actually incentivizes.", avgPrice: "$100" },
  { src: u("photo-1531218150217-54595bc2b934"), destination: "Austin, TX", tripType: "Group Trip", tags: ["Formals", "Domestic"], description: "Live music capital of the world with legendary 6th Street nightlife, rooftop bars, and a city that never slows down. Austin is one of the fastest growing formal and group trip destinations in the country.", avgPrice: "$100" },
  { src: u("photo-1582902281758-a4f26e3e0f61"), destination: "Toronto, ON", tripType: "Group Trip", tags: ["International", "Formals"], description: "A world-class city with incredible nightlife, diverse food, and a skyline that delivers. Toronto is the top international destination for groups looking to go north of the border.", avgPrice: "$100" },
  { src: u("photo-1558618666-fcd25c85cd64"), destination: "Montreal, QC", tripType: "Group Trip", tags: ["International", "Formals"], description: "Old world charm meets modern nightlife. Montreal is known for its vibrant club scene, incredible food, and a European feel that makes every group trip feel like a true getaway.", avgPrice: "$100" },
  { src: u("photo-1605833556294-ea5c7a74f57d"), destination: "Las Vegas, NV", tripType: "Group Trip", tags: ["Spring Break", "Domestic", "Corporate"], description: "Pool parties, world-class shows, and a Strip that was built for groups. Las Vegas is the ultimate domestic destination when your group wants to go big.", avgPrice: "$100" },
  { src: u("photo-1548574505-5e239809ee19"), destination: "Key West, FL", tripType: "Group Trip", tags: ["Spring Break", "Retreats", "Domestic"], description: "Duval Street, turquoise water, and a laid-back island vibe. Key West is the domestic spring break destination that feels like you left the country.", avgPrice: "$100" },
];
